function analyze_lorenz_3_systems(outputpath)

% FUNCTION ANALYZE_LORENZ_3_SYSTEMS(OUTPUTPATH) Example TRENTOOL analysis 
% script for simulated data from three coupled Lorenz systems:
%
%           1 ------> 2 ------> 3
% Delta:       20ms      20ms
%
...
cfgTESS.fileidout  = fullfile(outputpath, 'Lorenzdata_3');
