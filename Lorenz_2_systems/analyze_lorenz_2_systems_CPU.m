function analyze_lorenz_2_systems_CPU(outputpath)

% FUNCTION ANALYZE_LORENZ_2_SYSTEMS_CPU(OUTPUTPATH) Analyzes a toy example
% with two coupled Lorenz systems A1 -> A2 with a delay of 45 ms. This 
% function uses TRENTOOL CPU method to estimate TE.
%
