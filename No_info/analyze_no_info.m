function analyze_no_info

% FUNCTION ANALYZE_NO_INFO Analyzes a toy example with two coupled systems
% X and Y. X is a 50 Hz sine wave with amplitude 1 fixed phase shift
% of 0.2 ms. Y is an autoregressive process of order
...
inputpath  = '~/TRENTOOL_exampledata/No_info/';
outputpath = '~/no_info_results/';
file = dir([inputpath 'no_info_zero_noise_gamma=0.5.mat']);
load([inputpath file.name]);
...
% results file name
cfgTESS.fileidout  = strcat(outputpath,file.name(1:end-4));
